...
function buildSendText(stationNr, { temperature, pressure, humidity }) {
    return 'Station '+String(stationNr)+' an Zentrale:<br>Temperatur: '+String(temperature)+' °C,<br>Luftdruck: '+String(pressure)+' hPa,<br>Luftfeuchtigkeit: '+String(humidity)+'%';
}
...
optimierungsBtn.addEventListener('click', () => {
    ...
    window.open('01Optimierung.html', '_blank');
});
