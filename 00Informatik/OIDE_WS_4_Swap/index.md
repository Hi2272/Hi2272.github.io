 ...
 # Eine Methode zum Tauschen von Artikeln
 Programmiere eine Methode **swap** mit zwei Parametern **index1** und **index2**, die die Werte von art[index1] und art[index2] vertauscht.
