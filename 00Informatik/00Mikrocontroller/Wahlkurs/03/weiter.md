...
Eine C-Dur-Tonleiter kannst du jetzt ganz einfach mit folgendem Code programmieren:

```C++
tone(buzzer, NOTE_C1, 1000);
tone(buzzer, NOTE_D1, 1000);
tone(buzzer, NOTE_E1, 1000);
tone(buzzer, NOTE_F1, 1000);
tone(buzzer, NOTE_G1, 1000);
tone(buzzer, NOTE_A1, 1000);
tone(buzzer, NOTE_B1, 1000);
