...
xmlhttp.onload = function () {
    ...
    jsonData = JSON.parse(this.responseText);
     for (var j of jsonData.dataseries){
        console.log(j.timepoint/3+" "+j.temp2m);
    }
...
href = "http://universities.hipolabs.com/search?country=Germany";
href ="https://weatherdbi.herokuapp.com/data/weather/london";
href="https://www.7timer.info/bin/astro.php?lon=12.5219895&lat=48.2457722&ac=0&unit=metric&output=json&tzshift=0"
