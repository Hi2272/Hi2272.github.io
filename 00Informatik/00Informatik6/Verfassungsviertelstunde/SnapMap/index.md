...
## Notizblock
 <div style="position: relative; width: 95vw; height: 90vh;"> 
    <iframe src="https://dgm.sh/" frameborder="0" style="width: 100%; height: 100%; border: 2px solid #A00000;"></iframe> 
    <div style="position: absolute; bottom: 10px; left: 10px; background-color: rgba(255, 255, 255, 0.8); padding: 5px; font-family: Arial, sans-serif; font-size: 12px; color: #AAAAAA;">Quelle: <a href="https://dgm.sh">https://dgm.sh</a>
    </div>
  </div>
  <br><br>
